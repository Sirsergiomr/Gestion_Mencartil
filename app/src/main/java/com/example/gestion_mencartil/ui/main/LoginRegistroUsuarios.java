...
public class LoginRegistroUsuarios extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.RegisterButton: registrarUsuario();persistencia();
                break;
            case R.id.LoginButton:loguearUsuario();persistencia();
                break;
        }
    }
    ...
    private void registrarUsuario() {
        ...
        if (email.equals("")) {Toast.makeText(this, "Se debe ingresar un email", Toast.LENGTH_LONG).show();return;}

        if (password.equals("")) { Toast.makeText(this, "Falta ingresar la contraseña", Toast.LENGTH_LONG).show();return; }
            ...
            firebaseAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {Toast.makeText(LoginRegistroUsuarios.this, "Se ha logueado el usuario con el email: " + TextEmail.getText(), Toast.LENGTH_LONG).show();
                                persistencia();
                                session();
                            } else {Toast.makeText(LoginRegistroUsuarios.this, "No se pudo loguear el usuario ", Toast.LENGTH_LONG).show(); }
                            progressDialog.dismiss();
                        }
                    });
        }
